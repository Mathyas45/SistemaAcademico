...
VALUES
    ('Administrador', '2024-01-12 01:16:34', '1');

INSERT INTO
    roles (nombre_rol, fyh_creacion, estado)
VALUES
    ('Director Academico', '2024-01-12 01:16:34', '1');
...
INSERT INTO
    roles (nombre_rol, fyh_creacion, estado)
VALUES
    ('Secretaria', '2024-01-12 01:16:34', '1');

INSERT INTO
    roles (nombre_rol, fyh_creacion, estado)
VALUES
    ('Auxiliar', '2024-01-12 01:16:34', '1');

INSERT INTO
    roles (nombre_rol, fyh_creacion, estado)
VALUES
    ('Docente', '2024-01-12 01:16:34', '1');
...
INSERT INTO
    usuarios (rol_id, email, password, fyh_creacion, estado)
VALUES
    (
        '1',
        'admin@gmail.com',
        '$2y$10$.xgQGtzbd6a5L5A5zOykaO3oO1oNmD8YWfZ7Y2U4BM//quGkEs/Ni',
        '2023-12-20 20:29:10',
        '1'
    );
...
INSERT INTO
    administrativos (persona_id, fyh_creacion, estado)
VALUES
    ('1', '2023-12-20 20:29:10', '1');
...
CREATE TABLE
    estudiantes (
        ...
        fyh_actualizacion DATETIME NULL,
        estado varchar(11),
        FOREIGN KEY (persona_id) REFERENCES personas (id_persona) on delete cascade on update cascade FOREIGN KEY (nivel_id) REFERENCES niveles (id_nivel) on delete cascade on update cascade FOREIGN KEY (grado_id) REFERENCES grados (id_grado) on delete cascade on update cascade
    ) ENGINE = InnoDB;
...
INSERT INTO
    gestiones (gestion, fyh_creacion, estado)
VALUES
    ('2024-I', '2023-12-20 20:29:10', '1');
...
INSERT INTO
    niveles (gestion_id, nivel, turno, fyh_creacion, estado)
VALUES
    (
        '1',
        'PRIMARIA',
...
INSERT INTO
    grados (nivel_id, curso, seccion, fyh_creacion, estado)
VALUES
    (
        '1',
        'inicial - 1',
